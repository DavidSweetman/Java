...
public class HospitalGUI extends JFrame {
	...
	public HospitalGUI() {
		...
		error1TF.setFont(new Font("Tahoma", Font.PLAIN, 16));
		error1TF.setForeground(Color.RED);
		error1TF.setEditable(false);
		error1TF.setBounds(1, 81, 373, 26);
		panel.add(error1TF);
		error1TF.setColumns(10);
		
		JButton btnPrevious = new JButton("Get Previous");
		...
		btnPrevious.setBounds(1, 0, 187, 82);
		panel.add(btnPrevious);
		
		JButton btnNewButton = new JButton("Get Next");
		...
		btnGetNextPatient.setBounds(1, 0, 187, 82);
		...
		error2TF.setFont(new Font("Tahoma", Font.PLAIN, 16));
