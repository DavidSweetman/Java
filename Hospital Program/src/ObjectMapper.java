...
public class ObjectMapper {
            ...
            for (int i = 0; i < fields.length - 1; i++) {
                ...
                switch (value.getClass().toString()) {
                    ...
                    case "class java.lang.String":
                        if (counter == 0) {
                        	String valueChecked = StringChecker.checkString(value.toString());
                            insert_values = insert_values + "'" + valueChecked + "'";
                        } else {
    ...
    public void update() {
        try {
            ...
            String sql = "UPDATE " + db_tableName + " SET " + update_cols + " WHERE rowid=" + this.id + ";";
    ...
    public void delete() {
        Class<?> objClass = this.getClass();
        String db_tableName = objClass.getSimpleName() + "s";
        String sql = "DELETE FROM " + db_tableName + " WHERE rowid=" + this.id + ";";
        // execute the statement
        dbExecuteStatement(sql);
    }
    ...
    private int dbExecuteStatement(String sql) {
        ...
        try {
            ...
            c = DriverManager.getConnection("jdbc:sqlite:Hospital.sqlite");
